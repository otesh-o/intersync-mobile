...
//           onPress={() => router.replace({ pathname: '/Homepage/homepage', params: { startTutorial: 'true' } })}
//         >
//           <Text style={styles.guideButtonText}>Quick Guide</Text>
//         </TouchableOpacity>

//         <TouchableOpacity onPress={() => router.replace('/Homepage/homepage')}>
...
//   modalOverlay: {
//     flex: 1,
//     // Changed background color to match homepage.js
